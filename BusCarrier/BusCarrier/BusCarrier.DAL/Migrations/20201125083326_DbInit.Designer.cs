...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusCarrier.Domain.Entities.Route", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BusCarrier.Domain.Entities.RouteTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BusCarrier.Domain.Entities.Route", b =>
                {
                    b.HasOne("BusCarrier.Domain.Entities.RouteTemplate", "RouteTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("BusCarrier.Domain.Entities.Station", b =>
                {
                    b.HasOne("BusCarrier.Domain.Entities.RouteTemplate", null)
                        .WithMany("Stations")
                        .HasForeignKey("RouteTemplateId");

                    b.HasOne("BusCarrier.Domain.Entities.Station", null)
                        .WithMany("Services")
